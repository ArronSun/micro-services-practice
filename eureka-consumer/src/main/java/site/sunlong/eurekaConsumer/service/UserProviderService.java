 ...
 */
@FeignClient(name = "ZUUL-GATEWAY" , path = "zuul-proxy/user-providers-proxy/user" , contextId = "UserProviderService",fallbackFactory = UserProviderServiceFallbackFactory.class)
